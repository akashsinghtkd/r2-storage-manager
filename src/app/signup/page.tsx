...
import { Cloud, Mail, Lock, User, Eye, EyeOff, ArrowRight, Loader2, Shield, Zap, Globe } from "lucide-react";
      ...
      >
        ...
        <div className="relative z-10 space-y-8">
          ...
          <div className="space-y-4">
            {[
              { icon: Shield, label: "Secure by design", desc: "Your credentials stay encrypted" },
              ...
              >
                ...
                >
                  <feature.icon size={14} style={{ color: "#a5b4fc" }} />
                </div>
                <div>
      ...
      <div className="flex-1 flex items-center justify-center p-6 sm:p-10">
        ...
        >
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="space-y-2">
              ...
              <div
                ...
                style={{
                  boxShadow: focusedField === "name" ? "0 0 0 3px color-mix(in srgb, var(--accent) 20%, transparent)" : "none",
                }}
              >
                <User size={16} className="absolute left-4 top-1/2 -translate-y-1/2 transition-colors"
                  style={{ color: focusedField === "name" ? "var(--accent)" : "var(--text-muted)" }} />
                <input
                  ...
                  style={{ background: "var(--bg-input)", border: focusedField === "name" ? "1px solid var(--accent)" : "1px solid var(--border)", color: "var(--text-primary)" }}
                />
              </div>
            </div>
            ...
            <div className="space-y-2">
              ...
              <div
                className="relative rounded-[var(--radius-lg)] transition-all duration-200"
                style={{
                  boxShadow: focusedField === "email" ? "0 0 0 3px color-mix(in srgb, var(--accent) 20%, transparent)" : "none",
                }}
              >
                ...
                <input
                  ...
                  className="w-full h-12 pl-11 pr-4 rounded-[var(--radius-lg)] text-[14px] font-medium outline-none transition-all"
                  style={{ background: "var(--bg-input)", border: focusedField === "email" ? "1px solid var(--accent)" : "1px solid var(--border)", color: "var(--text-primary)" }}
                />
              </div>
            </div>
            ...
            <div className="space-y-2">
              ...
              <div
                className="relative rounded-[var(--radius-lg)] transition-all duration-200"
                style={{
                  boxShadow: focusedField === "password" ? "0 0 0 3px color-mix(in srgb, var(--accent) 20%, transparent)" : "none",
                }}
              >
                <Lock size={16} className="absolute left-4 top-1/2 -translate-y-1/2 transition-colors"
                ...
                <input
                  ...
                  style={{ background: "var(--bg-input)", border: focusedField === "password" ? "1px solid var(--accent)" : "1px solid var(--border)", color: "var(--text-primary)" }}
                />
              ...
              {password.length > 0 && (
                ...
                >
                  ...
                  <span className="text-[11px] font-bold" style={{ color: strengthColors[passwordStrength] }}>
          ...
          <p className="text-center text-[13px] mt-8" style={{ color: "var(--text-muted)" }}>
            ...
            <a href="/login" className="font-bold transition-colors hover:underline" style={{ color: "var(--accent)" }}>
              Sign in
            </a>
          </p>
        </motion.div>
